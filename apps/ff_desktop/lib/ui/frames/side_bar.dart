...
class SideBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return ChangeNotifierProvider.value(
      value: context.select((ExploreViewModel model) => model.sideBarViewModel),
                ...
                builder:
                    (
                      ...
                      return Column(
                        children: [
                          Expanded(
                            child: SideBarSectionsWidget(sections: sections),
                          ),
                          Padding(
                            ...
                            child: const ThemeToggle(isCollapsed: false),
                          ),
                        ],
                      );
                    },
...
class SideBarSectionsWidget extends StatelessWidget {
  ...
  const SideBarSectionsWidget({super.key, required this.sections});
      ...
      slivers: [
        for (final MapEntry<SideBarSection, List<TreeExploreViewModel>> entry
          ...
          if (entry.value.isNotEmpty) ...[
            SliverPadding(
              padding: EdgeInsets.only(top: Spacing.d24, bottom: Spacing.d4),
            ...
            SliverList.builder(
              itemBuilder: (context, index) {
                ...
                return SideBarTreeView(model: item);
              },
